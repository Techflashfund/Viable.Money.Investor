...
const createApiService = () => ({
  checkUsername: async () => ({ data: { available: true } }),
  register: async () => ({ message: 'OTP sent successfully' }),
  verifyOTP: async () => ({ message: 'OTP verified successfully' }),
  resendOTP: async () => ({ message: 'OTP sent again' }),
  loginRequest: async () => ({ message: 'OTP sent to your email' }),
  resendLoginOTP: async () => ({ message: 'Login OTP sent again' }),
  setPIN: async () => ({ message: 'Account created successfully', data: { username: 'demo' }, token: 'demo-token' }),
  loginVerify: async () => ({ message: 'Login successful', data: { username: 'demo' }, token: 'demo-token' })
});
...
const AuthPage = () => {
  ...
  // Registration flow - Mock API handlers
  ...
  // Mobile: Show intro section
  const renderIntroSection = () => (
    <div className="flex-1 flex flex-col relative min-h-screen">
      {/* Logo Section */}
      <div className="absolute top-8 left-4 md:left-12 z-30 right-4">
        <div className="flex items-center justify-between w-full">
          ...
          {isAuthenticated && user && (
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl px-3 md:px-4 py-2 shadow-lg border border-gray-200">
              <div className="flex items-center space-x-2 md:space-x-3">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="text-xs px-2 md:px-3 py-1 rounded-xl border-gray-300 hover:border-red-400 hover:text-red-600"
                >
                  Logout
                </Button>
              </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 pt-24 md:pt-32">
        <div className="relative z-20 max-w-lg text-center md:text-left">
          <h1 className="text-3xl md:text-5xl font-semibold font-sans text-black mb-6 md:mb-8 leading-tight">
            Smart Investing
            <span className="text-blue-600 block">Made Simple</span>
          </h1>
          
          <div className="h-20 md:h-24 mb-6 md:mb-8">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 text-sm text-gray-600 font-sans mb-8 md:mb-0">
          ...
          <div className="md:hidden">
            <Button
              ...
              className="w-full rounded-2xl bg-blue-600 hover:bg-blue-700 text-white py-4 px-8 text-base font-medium font-sans transition-all transform hover:scale-105 flex items-center justify-center space-x-2"
              size="lg"
            >
  ...
  const renderFormSection = () => (
    <div className="flex-1 flex items-center justify-center p-4 md:p-8 relative z-20 min-h-screen">
      <div className="w-full max-w-md">
        ...
        <div className="p-6 md:p-8 space-y-6 md:space-y-8 bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200">
          {/* Mode Toggle */}
          ...
          {currentStep === 1 && (
            <div className="space-y-4 md:space-y-6">
              <div className="text-center mb-4 md:mb-6">
                <h2 className="text-xl md:text-2xl font-bold text-black font-sans">{getStepTitle()}</h2>
                <p className="text-gray-600 mt-2 font-sans text-sm md:text-base">{getStepSubtitle()}</p>
              </div>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={`rounded-2xl bg-white focus:border-blue-600 focus:ring-blue-500 py-4 md:py-6 text-base md:text-lg font-sans pr-10 ${
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="rounded-2xl bg-white border-blue-300 focus:border-blue-600 focus:ring-blue-500 py-4 md:py-6 text-base md:text-lg font-sans"
                    />
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <div className="bg-white px-3 md:px-4 py-2 md:py-3 rounded-xl border-2 border-dashed border-gray-300 font-mono text-base md:text-lg font-bold text-black min-w-20 md:min-w-24 text-center">
              ...
              <Button
                ...
                className="w-full rounded-2xl bg-blue-600 hover:bg-blue-700 text-white py-4 md:py-6 text-base font-medium font-sans transition-all transform hover:scale-105"
                size="lg"
              >
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="123456"
                  maxLength="6"
                  className="rounded-2xl bg-white border-blue-300 focus:border-blue-600 focus:ring-blue-500 text-center text-xl md:text-2xl tracking-widest py-4 md:py-6 font-sans"
                />
              </div>
              ...
              <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3">
                <Button
                  ...
                  disabled={loading}
                  variant="outline"
                  className="flex-1 rounded-2xl border-blue-600 text-blue-600 hover:bg-blue-50 py-4 md:py-6 text-base font-medium font-sans"
                  size="lg"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex-1 rounded-2xl border-gray-400 text-gray-600 hover:bg-gray-50 py-4 md:py-6 text-base font-medium font-sans"
                  size="lg"
                >
                  Back
                </Button>
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 flex font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 flex w-full">
        ...
        <div className="md:hidden w-full">
          {!showForm ? renderIntroSection() : renderFormSection()}
        </div>
